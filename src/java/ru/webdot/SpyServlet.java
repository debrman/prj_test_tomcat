...
public class SpyServlet extends HttpServlet {
    ...
    //В случае сбоев возбуждаются исключения ServletException или IOException        
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SpyServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SpyServlet at " + request.getContextPath() + "</h1>");
            out.println("<h2>Servlet header names at " + request.getContextPath() + "</h2>");            
